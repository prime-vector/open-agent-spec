...
### Changed
- Spec version aligned to **1.2.9** across all `.agents/`, templates, Website content, REFERENCE.md, CONTRIBUTING.md, and README.
...
### Changed
- Spec version and docs aligned to **1.2.9** (open_agent_spec in examples, templates, Website, REFERENCE, CONTRIBUTING, HOMEBREW).
- Test plan doc renamed to `docs/TEST_PLAN_1.2.9.md`.
